# HimalayaQuant cTrader Layer

A Node.js communication layer for the cTrader [Open API](https://connect.spotware.com).<br><br>
**This implementation is created by Reiryoku Technologies and maintained by HimalayaQuant, Caius Citiriga and contributors.**

## Installation

```console
npm install @himalaya-quant/ctrader-layer
```
...
```javascript
const { CTraderConnection } = require('@himalaya-quant/ctrader-layer');
